...
def test(data,
    ...
    if save_json and len(jdict):
        ...
        anno_json = '/opt/ml/dataset/yolo_test.json'  # annotations json
    ...
    # -------------- 데이터에 맞게 inference ----------------
    print("\ntest_data 에 대해 inference를 시작합니다\n")
    annotation = '/opt/ml/dataset/test.json' # annotation 경로
    data_dir = '/opt/ml/dataset' # dataset 경로
    test_dataset = CustomDataset(annotation, data_dir)
    score_threshold = 0.05
    # check_point = '/opt/ml/weights/last.pt' # 체크포인트 경로

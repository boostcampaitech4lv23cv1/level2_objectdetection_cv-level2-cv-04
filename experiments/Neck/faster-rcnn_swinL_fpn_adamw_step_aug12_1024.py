...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/opt/ml/JDP/dataset/train.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/opt/ml/folded_anns/val_3.json',
        img_prefix='/opt/ml/JDP/dataset',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='faster_rcnn_swinl_pafpn_aug12_1024.py'),
            interval=10,
            log_checkpoint=True,
...
seed = 42
gpu_ids = [0]
work_dir = './workspace/work_dirs/faster_rcnn_swinl_pafpn_aug12_1024'
device = 'cuda'
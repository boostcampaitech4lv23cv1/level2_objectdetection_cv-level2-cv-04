    ...
    train=dict(
        ...
        dataset=dict(
            ...
            classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
                     ...
                     'Clothing'),
            ann_file=
            '/opt/ml/level2_objectdetection_cv-level2-cv-04/dataset/pseudo_train.json',
            img_prefix=
            '/opt/ml/level2_objectdetection_cv-level2-cv-04/dataset/',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True)
            ],
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='tood_x101_64x4d_fpn_mstrain_2x_coco_1024_mosaic_pseudo'),
            interval=10,
            log_checkpoint=True,
...
seed = 42
gpu_ids = [0]
work_dir = './workspace/work_dirs/tood_x101_64x4d_fpn_mstrain_2x_coco_1024_mosaic_pseudo'
device = 'cuda'

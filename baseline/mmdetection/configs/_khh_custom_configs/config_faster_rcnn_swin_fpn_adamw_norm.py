...
data_root = 'data/coco/'
img_norm_cfg = dict(
    mean=[0.484, 0.460, 0.431], std=[0.211,0.209,0.214], to_rgb=True)
train_pipeline = [
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='faster_rcnn_swin_fpn_adamw'),
            interval=10,
            log_checkpoint=True,
...
seed = 42
gpu_ids = [0]
work_dir = './workspace/work_dirs/faster_rcnn_swin_fpn_adamw'
device = 'cuda'

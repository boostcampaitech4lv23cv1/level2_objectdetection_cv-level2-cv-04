...
train_pipeline = [
    dict(
        type='MixUp', img_scale=(512, 512), ratio_range=(0.8, 1.6), pad_val=0),
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='faster_rcnn_swin_fpn_adamw_mixup'),
            interval=10,
            log_checkpoint=True,
...
seed = 42
gpu_ids = [0]
work_dir = '/opt/bro/workspace/work_dirs/faster_rcnn_swin_fpn_adamw_mixup'
device = 'cuda'

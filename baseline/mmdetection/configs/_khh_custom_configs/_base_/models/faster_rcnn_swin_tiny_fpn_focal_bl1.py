...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_cls=dict(
            type='FocalLoss', alpha=0.05, gamma=2.0, reduction='mean', loss_weight=1.0),
        loss_bbox=dict(
            type='BalancedL1Loss', beta=1.0, alpha=0.5, gamma=1.5, reduction='mean', loss_weight=1.0)
            ),
